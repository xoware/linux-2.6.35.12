...
void rtl8367_init_mac(u8 mac_port)
{
    ...
    SWITCH_REG_VALUE(0xf0) |= (tx<<14); /* tx*/
	#endif
	SWITCH_REG_VALUE(0xf0) |= (0x0<<4); // rx               //cypress
    SWITCH_REG_VALUE(0xf0) |= (0x0<<6); // tx               //cypress
