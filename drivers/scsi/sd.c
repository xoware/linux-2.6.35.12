...
// KH
// ------------------------------------------------------
//    20110629:  move the sata_disk_standby define to here
//               for the ATA modules
//
unsigned int sata_disk_standby[2][STAGGER_SATA_PORT_DISKS];
EXPORT_SYMBOL(sata_disk_standby);
// ------------------------------------------------------
...
static void sd_probe_async(void *data, async_cookie_t cookie)
{
	...
	put_device(&sdkp->dev);
        ...
        //KH
        sata_disk_standby[sdp->host->host_no][sdp->channel] = 1;
